...
26  Watch
  Star 10
 Fork 251udacity/frontend-nanodegree-mobile-portfolio
 branch: master  frontend-nanodegree-mobile-portfolio/views/js/main.js
Durant Schoondurant-udacity 21 days ago comply with all complaints from jshint
1 contributor
540 lines (485 sloc)  23.866 kb RawBlameHistory
*/
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var randomPizzaC = document.getElementsByClassName("randomPizzaContainer"),length;
    for (var i = 0; i < randomPizzaC; i++) {
...
var pizzasDiv = document.getElementById("randomPizzas"); //moved and cached.
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  frame++;
  //cached. move this before the window.performance, so I can measure the first scroll.
  var scroll = document.body.scrollTop;
  window.performance.mark("mark_start_frame");//performance mark to measure scroll in ms

  var items = document.getElementsByClassName('mover');

  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((scroll / 1250) + (i % 5));
    //in the future, I can use webkitTransform for playing dynamic movement.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 30; i++) { //no need for 200 pizzas if only a handful of pizzas are seen
